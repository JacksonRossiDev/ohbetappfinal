...
const Paywall = (props) => {
    ...
    height: 300,}}source={require('../../assets/tarpsLogo.png')} />  */}
           ...
           <View className="space-y-5 px-10 pt-5 pb-5">
            ...
            <MaterialCommunityIcons name="poker-chip" size={32} color="#36d8ff" />
            ...
            <MaterialCommunityIcons name="security" size={32} color="#36d8ff" />
                <View className="flex-1">
                    ...
                    <Text className="text-ohbet-blue text-sm font-extralight">
                        BetCoins are fully secure transaction tokens and prevent 100% of fraud
                    </Text>
                </View>
            </View>
           ...
           className="items-center px-10 py-5 border-2 border-[#36d8ff] mx-10 rounded-full mt-2">
            <Text className="text-ohbet-blue text-md text-center font-bold mb-1">100 BetCoins for $50</Text>
        ...
        //    className="items-center px-10 py-5 bg-[#36d8ff] mx-10 rounded-full">
           className="items-center px-10 py-5  bg-[#36d8ff] mx-10 rounded-full mt-2">
            <Text className="text-white text-md text-center font-bold mb-1">750 BetCoins for $75</Text>
           ...
           className="items-center px-10 py-5 border-2 border-[#36d8ff] mx-10 rounded-full mt-2">
            <Text className="text-ohbet-blue text-md text-center font-bold mb-1">1000 BetCoins for $100</Text>
            {/* <Text className="text-white">{currentOffering?.monthly?.product.priceString} / Month</Text> */}
           </TouchableOpacity>
        ...
        >
            <Text className="text-center text-[#36d8ff]">Restore Purchases</Text>
           </TouchableOpacity>
